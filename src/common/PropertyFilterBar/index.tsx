  ...
  const renderDropdown = (
    ...
    return (
      <>
        <div className="relative md:block hidden">
          <Menu as="div" className=" inline-block text-left shadow-custom ">
            <Menu.Button className="flex items-center border md:text-[10px] text-[10px] md:px-4 px-2 md:py-[6px] py-[4px] rounded-md font-Gordita-Medium bg-white text-black hover:bg-gray-100  text-nowrap ">
                ...
                <Menu.Item key={option}>
                  {({ active }) => (
                    <Button
                      ...
                      className={`block w-full border-[1px] md:text-[10px] text-[10px] md:text-wrap text-nowrap border-gray-200 font-Gordita-Medium md:rounded-[0px] rounded-[6px] px-2 py-1 text-left ${(filters[key] as string[]).includes(option)
        ...
        <div className="md:hidden block">
          <DropDown
            ...
            buttonElement={
              <Button
                className={twMerge(
                  "flex items-center border  rounded-[20px] text-[10px] md:px-4 px-2  py-[6px]  font-Gordita-Medium bg-white text-black hover:bg-gray-100 text-nowrap"
                )}
              >
                {/* {displayLabel} */}
      ...
      no-scrollbar md:p-0 p-2`
           ...
           border-gray-200 font-Gordita-Medium 
  ...
  return (
    <div className="flex md:overflow-visible flex-col overflow-x-auto custom-scrollbar  gap-3 pt-2 rounded-md relative ">
        ...
        <div className="flex-shrink-0 min-w-0 max-w-[150px] md:max-w-none">
          <DropDown
            ...
            buttonElement={
              <Button
                className={twMerge(
                  "flex items-center border rounded-[10px] md:text-[16px] text-[12px] md:px-4 px-2 md:py-[8px] py-[6px] font-Gordita-Medium bg-white text-black hover:bg-gray-100 text-nowrap"
                )}
              >
                {tabs.find((tab) => tab.tabKey === activeTab)?.buttonLabel}
                <IoMdArrowDropdown className="w-4 h-4 ml-2" />
      ...
      no-scrollbar md:p-2 p-2 md:text-[12px] text-[10px]`
          ...
          ${activeTab === tab.tabKey ? "bg-[#5297ff] text-white" : "bg-white"} 
          `
                  )}
                >
                  {tab.buttonLabel}
      ...
      <div className="flex md:overflow-visible overflow-x-auto  md:mb-0 mb-2 gap-x-2 pb-2">
        ...
        <div className="relative">
          {activeTab !== "plot" && (
            <Button
              ...
              className="border md:px-4 px-2 md:py-[6px] py-[4px] font-Gordita-Medium md:rounded-md  rounded-[20px] bg-white hover:bg-gray-100 md:text-[10px] text-[10px] text-nowrap"
            >
              Show Built-Up Area
            </Button>
          )}
            ...
            <div className="fixed top-0 right-0 w-96 h-full bg-white shadow-xl flex flex-col">
              ...
              <div className="p-4 border-t bg-white flex justify-center">
                <Button
                  ...
                  className="w-full bg-[#3586FF] text-white py-2 rounded-md font-Gordita-Medium hover:bg-blue-700"
                >
                  Apply Filters
                </Button>
              </div>
        ...
        <div className="hidden md:block">
          <Menu as="div" className="relative inline-block text-left">
            <Menu.Button className="flex items-center border md:px-4 px-2 md:py-[6px] py-[4px] md:text-[10px] text-[10px] rounded-md bg-white text-black font-Gordita-Medium hover:bg-gray-100  text-nowrap">
            ...
            <Menu.Items className="absolute left-0 mt-2 w-64 bg-white border rounded-md shadow-lg p-3 z-[9999] ">
              {filterOptions[activeTab]?.amenities && (
                <div className="mb-3">
                  <label className="text-black font-Gordita-Medium">
                    Amenities
                  </label>
        ...
        <div className="md:hidden block">
          <DropDown
            ...
            buttonElement={
              <Button
                className={twMerge(
                  "flex items-center border md:px-4 px-2 md:py-[6px] py-[4px] md:text-[16px] text-[10px] rounded-md bg-white text-black font-Gordita-Medium hover:bg-gray-100 text-nowrap"
                )}
              >
                More Filters
          ...
          >
            <div className="w-full max-w-xs bg-white border rounded-md shadow-lg p-3 z-[9999]">
              {filterOptions[activeTab]?.amenities && (
                <div className="mb-3">
                  <label className="text-black text-[14px] font-Gordita-Medium block mb-2">
                    Amenities
                  </label>
