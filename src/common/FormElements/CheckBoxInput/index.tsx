    ...
    return (
      <div className="flex w-full items-center gap-x-[10px]">
        ...
        {label && (
          <label
            htmlFor={id}
            className={twMerge("line-clamp-3 block w-full overflow-hidden text-ellipsis break-words text-xs font-Gordita-Regular leading-[15px] text-gray-800", labelCls)}
          >
            {label}
            {required && <sup>*</sup>}
          </label>
