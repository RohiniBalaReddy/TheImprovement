  ...
  return (
    <div className={twMerge("w-full", rootCls)}>
      <form ref={ref} {...otherFormProps}>
        ...
        {
          heading ? typeof heading === "string" ? heading.trim().length > 0 ? <p className={twMerge("text-lg w-full font-Gordita-Bold mb-7", headingCls)}>{heading}</p> : null : isValidElement(heading) ? <div className={twMerge("mb-7", headingCls)}>{heading}</div> : null : null
        }
        {
          subHeading ? typeof subHeading === "string" ? subHeading.trim().length > 0 ? <p className={twMerge("text-sm w-full font-Gordita-Medium mb-4", subHeadingCls)}>{subHeading}</p> : null : isValidElement(subHeading) ? <div className={twMerge("", subHeadingCls)}>{subHeading}</div> : null : null
        }
