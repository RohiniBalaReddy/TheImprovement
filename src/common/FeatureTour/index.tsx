    ...
    return (
        <div className="fixed inset-0 z-[9999] pointer-events-auto font-Gordita">
            ...
            >
                ...
                {step.title && (
                    <h3 className="md:text-lg text-[14px] font-Gordita-Medium text-neutral-900 dark:text-white mb-2 leading-tight">
                        {step.title}
                    </h3>
                )}
                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-xs font-Gordita-Medium text-neutral-500 dark:text-neutral-400 tabular-nums">
                        {index + 1} of {total}
                    </div>
                </div>
                ...
                <div className="flex items-center justify-between gap-3">
                    <Button
                        onClick={onClose}
                        variant="ghost"
                        className="inline-flex items-center text-nowrap text-[10px] md:text-[13px] font-Gordita-Medium px-3 py-2 rounded-lg text-neutral-600 dark:text-neutral-400 hover:text-neutral-800 dark:hover:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
                    >
                        Skip Tour
                    </Button>
                    ...
                    <div className="flex items-center gap-2">
                        <Button
                            ...
                            disabled={index === 0}
                            variant="outline"
                            className="inline-flex items-center gap-1 label-text font-Gordita-Medium rounded-lg px-3 md:py-2 py-1 border border-neutral-300 dark:border-neutral-600 text-neutral-700 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                        >
