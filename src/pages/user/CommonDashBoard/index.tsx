  ...
  return (
    <>
      {columns && Array.isArray(columns) && columns.length > 0 ? <DropDown
        ...
        buttonElement={<div className='flex gap-3 cursor-pointer px-3 py-2 bg-slate-300 rounded items-center'><span className='text-gray-700 font-Gordita-Medium'>Columns</span> <MdOutlineArrowDropDown className="text-black cursor-pointer text-[20px]" /></div>}
      >
    ...
    <>
      <div className="w-full min-h-full px-5 py-7 bg-[#FFFDF0]">
        ...
        <div className="flex justify-between items-start mb-10 gap-6">
          <span className="text-2xl font-Gordita-Bold">{heading}</span>
