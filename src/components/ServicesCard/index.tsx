...
const ServicesCard = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      href: "/services/custom-builder/construction-for-business",
    },
    {
      image: "/images/services/interiors.png",
      label: "Interiors",
      href: "/services/custom-builder/interiors",
    },
    {
      image: "/images/services/furnitures.png",
      label: "Furniture",
      href: "/services/custom-builder/furnitures",
    },
  ];
      ...
      {services.map((service: any, index: number) => (
        ...
        >
          ...
          <div className="flex flex-row justify-between items-center py-4 px-3">
            <p className="font-Gordita-Medium text-[20px] leading-7">
              {service.label}
            </p>
            <Link href={service.href}>
              <Button className="bg-[#4992FF] text-white p-1 rounded-md text-[16px] text-nowrap">
                <p>View More</p>
              </Button>
            </Link>
          </div>
