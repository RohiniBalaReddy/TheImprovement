        ...
        <section className="py-12 md:py-16 bg-[#F7FAFF] dark:bg-[#0b1220]">
            <div className="max-w-6xl mx-auto px-5">
                <div className="text-center mb-10">
                    <p className="font-Gordita-Bold text-2xl md:text-[28px] text-[#0b1220] dark:text-white">
                        Our Journey
                    </p>
                    <p className="mt-2 text-sm md:text-base text-[#5E6470] dark:text-[#B9C1D0] font-Gordita-Medium">
                             ...
                             group-hover:-translate-y-1 group-hover:shadow-[0_10px_28px_rgba(9,36,75,0.10)]"
                                >
                                    ...
                                    {m.href && m.cta && (
                                        <a
                                            href={m.href}
                                            className="inline-flex items-center gap-2 text-[13px] mt-3 font-Gordita-Medium text-[#2B6BE7] hover:underline"
                                        >
                                            {m.cta}
