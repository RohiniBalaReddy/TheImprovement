        ...
        <div className="w-full min-h-[inherit] flex md:flex-row flex-col gap-y-[40px] items-center border-yellow-300">
            ...
            <div className="relative w-full  ">
              <Slider ref={sliderRef} {...sliderSettings}>
                {listItems.map((item, index) => (
                  <div className="flex flex-col items-center gap-y-[48px] pb-[34px]">
                    <div
                      key={index}
                        ...
                        <div className="relative max-w-[243.45px] min-h-[80px] flex items-center gap-x-[9px] justify-center" onClick={() => router.push("/")}>
                          ...
                          <div className="flex flex-col justify-center pt-[8px] items-center">
                            ...
                            <div className="max-w-[148.28px] min-h-[13.08px]  mb-0">
                              <p className="font-Gordita-Bold text-[#000000] text-[8.97px] leading-[12.78px] tracking-[0.12em] ">
          ...
          <div className=" xl:p-10 md:w-[50%] md:my-auto w-full p-5">
            <div className="max-w-[490px] mx-auto">
              <h1 className="font-Gordita-Bold md:text-[32px] text-[24px] leading-[24px] mb-3">
                Login/Register
              </h1>
              <h2 className="leading-[22.8px] text-gray-400 text-[14px] font-Gordita-Regular mb-[22px]">
              ...
              <form className="mb-10" onSubmit={handleSubmit}>
                <CustomInput
                  ...
                  rootCls="mb-6"
                  labelCls="text-base font-Gordita-Medium md:text-[14px] text-[14px]"
                  type={isEmail ? "email" : "number"}
                  required
                  errorMsg={error}
                  placeholder={`Enter your ${isEmail ? "email" : "phone number"
                    }`}
                  className=" md:text-[14px] py-1 text-[12px] font-Gordita-Regular"
                ...
                <div className="flex items-center my-4">
                  ...
                  <span className="mx-4 text-gray-500 font-Gordita-Medium">or</span>
                  <div className="flex-grow border-t border-gray-300"></div>
                </div>
