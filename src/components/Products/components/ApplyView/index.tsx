    ...
    return (
        <div className='mx-auto w-full p-5'>
            <div className='flex items-center gap-2 cursor-pointer'>
                <ArrowLeft />
                <p className='font-Gordita-Medium text-[16px]' onClick={() => router.back()}>Back</p>
            </div>
            <div className='max-w-[820px] rounded-lg mx-auto px-10 py-4 shadow-xl'>
                <div className="">
                    <h1 className="text-[24px] font-Gordita-Medium mb-4">Apply for Job</h1>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="flex flex-col gap-3 w-full">
                            <CustomInput
                                name="name"
                                label="Full Name"
                                labelCls="text-[16px] font-Gordita-Medium"
                                className="p-[6px]"
                            ...
                            <div className='flex flex-col w-full my-3'>
                                <div className='flex flex-row w-full justify-between mb-4'>
                                    <p className="text-[16px] font-Gordita-Medium mb-2">Qualifications</p>
                                    <Button className='bg-[#3B82F6] text-white py-1 px-4 rounded-md' onClick={() => { setIsQualification(true) }}>
                                        <span className="text-[16px] font-Gordita-Regular">+ add</span>
                                    </Button>
                                </div>
                            ...
                            <div className='flex flex-col w-full my-3'>
                                <div className='flex flex-row w-full justify-between mb-4' >
                                    <p className="text-[16px] font-Gordita-Medium mb-2">Work Experience</p>
            ...
            <Modal isOpen={isQualification} closeModal={() => setIsQualification(false)} className='flex flex-col max-w-[600px] mx-auto'>
                <div className='flex flex-col mx-auto justify-center items-center'>
                    <h2 className="text-[24px] font-Gordita-Medium mb-4">Qualification</h2>
                    <CustomInput
                        name="degree"
                        label="Degree"
                        labelCls="text-[16px] font-Gordita-Medium"
                    ...
                    <CustomInput
                        ...
                        errorMsg={errors?.qualification}
                    />
                    {errors?.qualification && <p className='text-red-500 font-Gordita-Medium'>{errors.qualification}</p>}
                    <Button
            ...
            >
                <div className='flex flex-col '>
                    <h2 className="text-[24px] font-Gordita-Medium mb-4">Add Work Experience</h2>
                    <CustomInput
                        name="company"
                        label="Company"
                        labelCls="text-[16px] font-Gordita-Medium"
                    ...
                    />
                    {errors?.workExperience && <p className='text-red-500 font-Gordita-Medium'>{errors.workExperience}</p>}
                    <Button
                        className="mt-4 w-full py-3 text-white rounded-md bg-[#3B82F6]"
