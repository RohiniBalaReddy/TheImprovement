            ...
            <div className='w-full relative md:h-[500px] bg-black bg-opacity-[0.7]'>
                ...
                <div className='flex flex-col md:flex-row w-full h-full'>
                    <div className='md:w-[50%] px-11 py-6'>
                        <p className='text-[#FFFFFF] font-Gordita-Medium md:font-Gordita-Bold text-[24px] md:text-[27px] lg:text-[24px] lg:leading-[44.17px] text-start mb-8'>
                            Why Choose Us
                        </p>
                        <p className='text-[#FFFFFF] font-Gordita-Medium md:font-Gordita-Bold text-[24px] md:text-[27px] lg:text-[32px] lg:leading-[44.17px] text-start mb-8'>
                        ...
                        <div className='flex flex-wrap gap-6'>
                            {features.map((feature, index) => (
                                <div key={index} className='flex items-start gap-3 w-full sm:w-[45%]'>
                                    ...
                                    <div>
                                        <p className='text-[#FFFFFF] font-Gordita-Bold text-[16px]'>{feature.title}</p>
                                        <p className='text-[#FFFFFF] font-Gordita-Regular text-[14px]'>{feature.description}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
