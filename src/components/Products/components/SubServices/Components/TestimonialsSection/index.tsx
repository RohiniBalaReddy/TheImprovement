  ...
  return (
    <div className="md:py-[48px] py-[38px] px-[24px] bg-[#EDF3FC] -z-10">
      {/*<div className="flex  items-center justify-center gap-2 mb-[81px] md:w-full md:h-full max-w-[380px] min-h-[29px] w-full">
        <span className="text-[20px] leading-[28.5px] md:font-Gordita-Medium font-Gordita-Bold md:text-[24px] md:leading-[34.2px] ">
          Testimonials
        </span>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:mb-[81px] mb-[30px]">
        <span className="text-[16px] leading-[24.5px] md:font-Gordita-Medium font-Gordita-Bold md:text-[24px] md:leading-[34.2px] ">
          Testimonials
        </span>
          ...
          {words.map((word, index) => {
            return (
              ...
              >
                ...
                <p className="text-center text-[20px]  text-xl leading-[28.5px] text-[#000000] mb-4 max-w-[67px] min-h-[29px] font-Gordita-Regular">
                  {word.name}
                </p>
                <p className="text-[#7B7C83] text-[13px] leading-[24px] mb-2 text-center max-w-[193px] min-h-[96px] font-Gordita-Regular">
