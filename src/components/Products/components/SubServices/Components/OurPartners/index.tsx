    ...
    <div className="w-full relative overflow-hidden md:py-8 py-4 px-6 md:px-12 bg-[#f0f4f8]">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center md:text-left mb-6 md:mb-8">
          <h1 className="font-Gordita-Medium text-[18px] md:text-[24px] text-[#1e3a8a] md:mb-4 mb-2">
            Our Partners
          </h1>
          <p className="font-Gordita-Regular text-[14px] md:text-[18px] text-gray-700 md:leading-7 leading-6 max-w-3xl mx-auto md:mx-0">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 md:gap-6 gap-3 mt-2  md:mt-4 mx-auto">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-[12px] md:text-[16px] font-Gordita-Medium text-gray-700 mt-1 text-center">
                {stat.label}
              </div>
