...
const FAQSComp = ({ image, faqs }: FAQSProps) => {
  ...
  return (
    <div className="mt-12 mx-auto rounded-lg  mb-10">
      <h1 className="leading-9 md:text-[24px] text-[18px] font-Gordita-Bold text-center md:mb-8 mb-4 text-[#081221]">
          ...
          {faqs.map((faq, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <h2 className="md:text-[16px] text-[12px] font-Gordita-Medium text-[#081221]">
                    {faq.question}
                  </h2>
                  <span
                    className={`
                ...
                >
                  <div className="overflow-hidden">
                    <p className="md:text-[12px] text-[10px] font-Gordita-Regular text-gray-600 leading-relaxed">
                      {faq.answer}
                    </p>
                  </div>
                </div>
