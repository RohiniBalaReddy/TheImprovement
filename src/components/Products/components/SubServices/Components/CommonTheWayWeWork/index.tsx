...
function CommonTheWayWeWork({
  ...
  return (
    <div>
      <h1 className="px-3 text-center font-Gordita-Medium text-[19px] md:text-[24px] md:leading-[34.2px] mb-4">
        {heading}
      </h1>
      <h2 className="px-3 text-center font-Gordita-Regular text-[16px] md:text-[20px] md:leading-[28.5px] mb-10 md:mb-16">
        {subHeading}
      </h2>
