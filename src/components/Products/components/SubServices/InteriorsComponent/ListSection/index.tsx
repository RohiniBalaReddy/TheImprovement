...
function ListSection({ heading, subHeading, list }: IListSectionProps) {
    ...
    return (
      <div
        ...
        className={clsx(
          ...
          isLargeImage
            ? "w-full md:max-w-[370px] max-w-[100px] md:h-[258px] h-[100px] "
            : "md:w-[370px] w-[100px] md:h-[258px] h-[100px] "
        )}
      ...
      >
        <div className="relative w-full h-full overflow-hidden md:rounded-[10px] rounded-[6px]">
          ...
          <div className="absolute bottom-2 right-2 text-transparent px-2 py-2 rounded-md flex flex-row gap-1 items-center transition-opacity duration-300 ease-in-out group-hover:opacity-100 opacity-0">
            <p className="text-white text-[14px] md:font-Gordita-Medium font-Gordita-Regular hidden md:block">
        ...
        <p
          className={clsx(
            "md:text-[15px] text-[12px] font-Gordita-Medium text-start text-[#7B7C83] md:mt-3 mt-2",
  ...
  return (
    <div className="flex flex-col items-center justify-centers">
      <h1 className="font-Gordita-Bold md:text-[24px] text-[18px] mb-3">
        {heading}
      </h1>
      <h2 className="font-Gordita-Medium text-[#7B7C83] md:text-[20px] text-[14px] md:mb-[50px] mb-[20px]">
        {subHeading}
      </h2>
