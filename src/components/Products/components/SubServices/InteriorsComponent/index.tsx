...
const InteriorsComponent = ({
  ...
  const PackagesData = {
    heading: "Packages",
    subHeading: " You have mutiple options to choose from",
  };
  const PartnerImages = [
    {
    ...
    <div>
      <div>
        <BreadCrumb
          steps={[
            ...
            { label: "Interiors", link: "/services/custom-builder/interiors" },
          ]}
          currentStep="Interiors"
        />
      </div>
      <div className="mb-[20px] md:mb-[64px]">
      ...
      <div className="fixed bottom-[8%]  left-0 w-full bg-white shadow-md border-t pb-1 px-4 z-50 md:hidden block ">
        <div className="max-w-[1600px]  w-full mx-auto  p-1 flex items-center justify-center">
          <Button
            className="bg-[#3586FF] font-Gordita-Medium md:px-5 px-3 md:py-3 py-1 md:text-[16px] text-[12px] rounded-[4px] text-white md:max-w-[50%] w-full flex items-center justify-center gap-2"
      ...
      <div className="md:px-0 px-1  mb-[60px] md:mb-[64px]">
      ...
      <div className="flex flex-col items-center gap-y-[20px] mb-[45px] md:mb-[64px]">
        ...
        <div className="max-w-[398px] min-h-[29px] flex items-center md:gap-x-[231px] gap-x-[118px] md:hidden md:px-3 px-2">
          <div className="max-w-[109px] min-h-[29px] ">
            <h1 className="text-[#000000] font-Gordita-Medium text-[20px] text-nowrap pl-[10px] leading-[28.5px]">
              Our Blogs
            </h1>
          </div>
          {blogs.length > 3 && (
        ...
        <div className="flex flex-wrap md:flex-row flex-col justify-center items-center gap-5">
          {blogs.length > 0 ? (
            ...
            <p className="text-center font-Gordita-Medium">No blogs found.</p>
          )}
