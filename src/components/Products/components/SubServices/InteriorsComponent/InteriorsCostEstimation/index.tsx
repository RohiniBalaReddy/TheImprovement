  ...
  return (
    <div className="flex flex-col items-center md:gap-y-[40px] gap-y-[20px] mx-auto max-w-[1392px]">
      <div className="flex flex-col items-center md:gap-y-[4px] gap-y-[5px]">
        <h1 className="font-Gordita-Bold uppercase md:text-[25px] text-[18px] md:leading-[35.62px] leading-[28.5px] text-[#212227]">
          {data.heading}
        </h1>
        <h2 className="font-Gordita-Regular px-3 text-center md:text-[18px] text-[14px] md:leading-[22.8px] leading-[15px] text-[#7B7C83] mt-2">
          {data.subHeading}
        </h2>
      </div>
        ...
        <div className="flex mx-auto shadow-custom w-full">
          ...
          <div className="md:pl-5  pl-0 md:py-6 py-3 flex flex-col justify-between items-center bg-white  rounded-[16px] w-full max-w-lg mx-auto md:h-[320px] h-[220px]">
            ...
            <div className="flex flex-col md:gap-y-4 gap-y-2 w-full text-center md:px-5 px-3 md:pb-[10px] pb-[5px]">
              <div className="font-Gordita-Bold  md:text-[20px]  text-[14px] text-[#000000]">
                {data.contentTitle}
              </div>
              <div className="font-Gordita-Medium text-[#7B7C83] md:text-[14px]  text-[12px] md:leading-[20px] leading-[18px]">
                {data.contentDescription}
              </div>
            </div>
            <Button
              className="bg-[#3586FF]  md:px-20 px-6 md:py-3 py-2 md:rounded-[6px] uppercase rounded-[4px] md:text-[16px] text-[12px] font-Gordita-Bold text-white cursor-pointer"
              onClick={() =>
