      ...
      <div className="w-full bg-white/95 backdrop-blur-md md:rounded-2xl rounded-md shadow-xl px-3 py-4 md:px-10  border border-white/20 md:max-h-[700px] max-h-[820px] overflow-auto">
        <div className="mb-4">
          <Button
            ...
            className="mt-3 bg-white border flex items-center justify-center md:py-2 py-1 px-4 font-Gordita-Medium rounded-[6px]  text-[14px] text-gray-700 hover:bg-gray-100"
          >
            <MdEdit className="mr-2 text-[#5297FF]" />  Edit  Estimate
          </Button>
        </div>
        ...
        <div className="mb-4 text-center">
          ...
          <h2 className="text-[16px] md:text-xl font-Gordita-Bold text-[#5297FF]">
        ...
        <h6 className="md:text-xl text-[18px] font-Gordita-Bold  mb-2 text-gray-800">
          Cost Breakdown:
        </h6>
        <div className="flex justify-between items-center md:mb-6 mb-3">

          <div>
            <h4 className="md:text-3xl text-[14px] text-[#5297ff] font-bold flex items-center">
              <span className="md:text-3xl text-[16px] text-[#5297ff] font-Gpordita-Bold flex items-center">
                <span className=" text-[12px]  text-[#c7b526d5] mb-2">Starts at</span>&nbsp;{formatCurrency(calculation.totalCost)}
              </span>

              <span
                className="text-[#5297ff] text-sm ml-2 cursor-pointer relative"
            ...
            <span className="md:text-md text-[13px] font-Gordita-Medium text-gray-600">
        ...
        <div className="grid md:gap-4 gap-2">
            ...
            ([room, { area, cost }]) => (
              ...
              >
                <div className="flex items-center md:gap-2 gap-1">
                  ...
                  <div>
                    <span className="md:text-[18px] text-[15px] font-Gordita-Medium capitalize text-gray-700">
                ...
                <span className="md:text-[16px] text-[13px] font-Gordita-Medium text-[#5297ff]">
                  {formatCurrency(cost)}
                </span>
              </div>
          ...
          >
            <div className="flex items-center md:gap-2 gap-1">
              <Layers />
              <div>
                <span className="md:text-[16px] text-[14px] font-Gordita-Medium capitalize text-gray-700">
                  False Ceiling (POP)
                </span>
                <p className="md:text-[12px] text-[10px] text-gray-500">approx</p>
              </div>
            </div>
            <span className="md:text-[16px] text-[12px] font-Gordita-Medium text-[#5297ff]">
        ...
        <div className="mt-6">
          ...
          <ul className="list-none text-gray-700 font-Gordita-Regular text-[13px] space-y-2">
        ...
        <div className="text-center">
          <p className="text-sm md:text-md text-gray-600 font-Gordita-Regular">
          ...
          <p className="mt-2  text-[#ecbc43] text-[14px] font-Gordita-Regular bg">
            ...
            <div className="text-black">
              ...
              <a href="tel:+918897574909" className="underline text-[#5297ff] hover:text-blue-800 ml-2 transition">
                8897574909
              </a>
              ,{" "}
              <a href="tel:+918106120099" className="underline text-[#5297ff] hover:text-blue-800 transition">
                8106120099
              </a>{" "}
              or mail us at{" "}<MdEmail className="inline" />
              <a href="mailto:dreama@example.com" className="underline text-[#5297ff] hover:text-blue-800 transition">
                sales@onecasa.in
              </a>.
            </div>
          </p>
