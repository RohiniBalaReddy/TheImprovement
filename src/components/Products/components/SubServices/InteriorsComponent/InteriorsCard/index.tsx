...
const InteriorsCard = ({
  ...
  return (
    <div
      className="md:max-w-[313px] max-w-[150px] md:min-h-[370px] min-h-[170px] shadow-custom rounded-[8px] hover:scale-105 cursor-pointer transition-all duration-300 ease-in-out sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 bg-gray-100 border border-black"
    ...
    >
      ...
      <div className="flex flex-col md:gap-2 gap-0.5 px-4 py-3">
        <p className="md:text-[14px] text-[10px] font-Gordita-Medium text-gray-600  text-center  mb-3  md:h-[46px] h-auto md:mb-4 ">
          {title}
        </p>
        <Button className="md:rounded-[8px] rounded-[4px] hover:text-white hover:bg-[#5297FF]border-2 font-Gordita-Bold md:text-[16px] text-[10px] text-white bg-[#5297ff] border-blue-400 md:p-2 p-0.5  hover:bg-[5297FF]">
          {buttonLabel}
        </Button>
      </div>
    </div>
      ...
      {loading ? (
        ...
        >
          ...
          <div className="md:py-[68px] py-[44px] md:w-[50%] w-[90%] md:px-[80px] px-[40px] flex flex-col items-center justify-center md:gap-6  gap-3 bg-color-gradient rounded-[4px] md:ml-0 ml-3">
            <h1 className="md:text-[32px] text-[20px] font-Gordita-Bold max-w-[536px] text-center">
              Interior Design Budget Calculator
            </h1>
            <h2 className="md:mb-[24px] mb-[16px] md:text-[16px] text-[12px] text-center text-gray-700 font-Gordita-Medium max-w-[436px]">
              Get an approximate budget for your home interior design by sharing
              your space details.
            </h2>
            <Button className="md:w-[240px] w-[180px] bg-[#5297FF] md:rounded-[8px] rounded-[4px] md:p-3 p-2 md:text-[20px] text-[14px] font-Gordita-Bold  text-white hover:opacity-80">
              Get Started
            </Button>
          </div>
        </div>
  ...
  return (
    <div className="px-6 py-6">
      ...
      <div className="mb-10 flex flex-col md:gap-4 gap-2 md:mt-[64px] mt-[20px]">
        <h1 className="md:text-[24px] text-[18px]  font-Gordita-Medium md:text-left text-center md:leading-9 leading-5">
          {title}
        </h1>
        <h2 className="md:text-[16px] text-[12px] font-Gordita-Medium md:text-left text-center md:leading-9 leading-6 text-[#7B7C83]">
          {subTitle}
        </h2>
      </div>
      {loading ? (
