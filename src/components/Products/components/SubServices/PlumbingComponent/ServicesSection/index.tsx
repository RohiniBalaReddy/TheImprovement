          ...
          {sections.map((section, index) => (
            ...
            >
              <div className="max-w-[186px] min-h-[34px]">
                <h1 className="text-[#000000]  text-[24px] leading-[34.2px] font-Gordita-Bold ">
                  {section.heading}
                </h1>
              </div>
                      ...
                      <div className="flex flex-col gap-y-[16px] px-3">
                        <div className="flex items-center gap-x-[16px] max-w-[413px] min-h-[29px]">
                          <div className="max-w-[326px] min-h-[29px]">
                            <h2 className="text-[#000000] text-center  text-[20px] font-Gordita-Medium leading-[28.5px]">
                              {item.heading}
                            </h2>
                          </div>
                          <div className="max-w-[71px] min-h-[19px]">
                            <h1 className="text-[#000000] text-center  text-[13px] font-Gordita-Regular leading-[18.52px]">
                              ({item.time})
                            </h1>
                          </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-y-[12px]">
                          <div className="flex items-center gap-x-[16px]">
                            <div className=" max-w-[123px] min-h-[23px] text-[16px] leading-[22.8px] text-center gap-2">
                              ...
                              <span className="font-Gordita-Medium text-green-500">
                                {item.price}
                              </span>
                            </div>
                            <div className="max-w-[47px] min-[23px] flex items-center gap-1">
                              ...
                              <span className="text-[#4B4B4B]  max-w-[27px] min-[23px] text-center  text-[16px] font-Gordita-Medium leading-[22.8px]">
                                {item.rating}
                              </span>
                            </div>
                          </div>
                          <div className="max-w-[75px] min-[23px]">
                            <h1 className="text-[#FE2323]  text-[16px] leading-[22.8px] font-Gordita-Regular line-through text-center">
                              {item.cancelprice}
                            </h1>
                          </div>
              ...
              <div className="w-full min-h-[187px] flex items-center justify-center border-[1px] border-[#C3C3C3] rounded-[8px] shadow-custom">
                <div className="flex flex-col items-center gap-y-[4px]">
                  ...
                  <div className="max-w-[175px] min-h-[23px]">
                    <h1 className="text-[#555555]  text-[16px] leading-[22.8px] font-Gordita-Regular text-center">
                      {section.text}
                    </h1>
                  </div>
                </div>
                ...
                {section.dataItems.map((item, index) => (
                  <div className="flex items-center gap-x-[16px] max-w-[263px] min-h-[54px] rounded-[8px]">
                    ...
                    <div className="flex flex-col gap-y-[2px]">
                      <h1 className="text-[#000000]    text-[16px] font-Gordita-Medium leading-[22.8px]">
                        {item.title}
                      </h1>
                      <h1 className="text-[#9C9C9C]    text-[16px] font-Gordita-Regular leading-[22.8px]">
                        {item.description}
                      </h1>
                    </div>
                  </div>
