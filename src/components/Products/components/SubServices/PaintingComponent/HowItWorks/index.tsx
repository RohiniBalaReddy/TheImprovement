...
const steps = [
  ...
  },
  {
    ...
    image: "https://dreamcasaimages.s3.ap-south-1.amazonaws.com/approval_4d9fcc8a3b.webp",
  },
];
    ...
    <section className="md:py-8 py-4 bg-gradient-to-br from-slate-50 via-white to-blue-50/30 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-full gap-4">
          <p className="flex-1 font-Gordita-Medium md:text-[18px] text-[12px] text-gray-500">
            OneCasa will help renovate your house in{" "}
            <span className="font-Gordita-Bold text-gray-800">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row  justify-between  items-center md:gap-9 gap-3  w-full h-full">
            <div className="flex-1 flex flex-col justify-center items-start p-1 md:p-3 text-white md:gap-3 gap-1">
              <h3 className="text-[24px] md:text-[32px] font-Gordita-Bold uppercase leading-tight">
                UNLOCK
              </h3>
              <h4 className="text-[20px] md:text-[28px] font-Gordita-Bold leading-tight">
                BEST DEALS
              </h4>
              <p className="font-Gordita-Medium text-[14px] md:text-[16px]">
