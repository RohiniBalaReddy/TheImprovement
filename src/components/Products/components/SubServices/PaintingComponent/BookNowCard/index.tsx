      ...
      <div className="relative bg-gradient-to-r from-[#2872a1] to-indigo-700 p-6 text-white">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-blue-100 md:text-[16px] text-[12px] font-Gordita-Medium opacity-90">
              Complete interior painting solution
            </p>
          </div>
          <div className="bg-yellow-400 text-gray-900 px-3 py-1 rounded-full text-[10px] md:text-[12px] font-Gordita-Medium">
            Popular
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:gap-6 gap-3 md:p-6 p-3">
        <div className="md:w-1/2 flex flex-col md:gap-4 gap-2">
          ...
          <div className="bg-white rounded-xl md:p-4 p-2 shadow-inner border border-gray-200">
            <h3 className="font-Gordita-Bold text-gray-900 mb-2">
              Pricing Breakdown
            </h3>
            <div className="space-y-1 md:text-[14px] text-[10px] text-gray-600 font-Gordita-Medium">
        ...
        <div className="md:w-1/2 flex flex-col justify-between md:gap-4 gap-2">
          <div className="grid grid-cols-2 md:gap-4 gap-2 bg-blue-50 md:p-4 p-2 rounded-lg">
            <div className="text-center">
              <div className="text-gray-600 font-Gordita-Medium md:text-[14px] text-[12px] mb-1">
                Select BHK
              </div>
              <select
                value={bhk}
                ...
                className="w-full border border-gray-300 rounded-lg md:text-[14px] text-[12px] text-center py-1 font-Gordita-Regular"
              >
            ...
            <div className="text-center">
              <CustomInput
                type="number"
                label="Area (sq.ft)"
                labelCls="text-gray-600 font-Gordita-Medium md:text-[14px] text-[12px] mb-1 py-0"
                rootCls="py-0"
                value={sqft}
              ...
              <div className="flex items-center justify-between md:p-4 p-2 bg-white rounded-xl border-2 border-gray-200 hover:border-blue-300 transition-all duration-200">
                <div className="flex items-center md:gap-3 gap-1">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] md:text-[12px] font-Gordita-Medium text-gray-600">
            ...
            {/* Addons */}
            <div className="md:col-span-2 col-span-2">
              <label className="block text-[12px]  md:text-[12px] font-Gordita-Bold text-gray-700 md:mb-3 mb-1">
                Premium Add-ons
              </label>
                ...
                {addons.map((addon, i) => (
                  ...
                  >
                    <div className="flex items-center md:gap-3 gap-1">
                      ...
                      <div>
                        <div className="font-Gordita-Medium md:text-[16px] text-[12px] text-gray-900">
                          {addon.name}
                        </div>
                        <div className="font-Gordita-Regular md:text-[16px] text-[12px] text-gray-600">
          ...
          <div className="flex justify-center items-center md:mt-3 mt-1 space-x-6 font-Gordita-Regular md:text-[12px] text-[8px] text-gray-500">
