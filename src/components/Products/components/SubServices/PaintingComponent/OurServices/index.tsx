    ...
    `}>
      ...
      <div className="relative z-10 h-full flex flex-col justify-end p-8 text-white">
        ...
        <div className="space-y-3 transform transition-transform duration-300 group-hover:translate-y-[-5px]">
          ...
          <p className="font-Gordita-Regular md:text-[16px]  text-[14px] md:leading-5 leading-5 opacity-0 max-h-0 group-hover:opacity-100 group-hover:max-h-20 transition-all duration-500 ease-in-out">
            {description}
          </p>
        </div>
