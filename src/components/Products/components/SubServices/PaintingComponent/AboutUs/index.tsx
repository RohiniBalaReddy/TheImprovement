      ...
      <div className="relative flex flex-col lg:flex-row gap-12 lg:gap-16 justify-between items-center px-6 sm:px-4 lg:px-12 py-16 lg:py-20 mt-10 max-w-7xl mx-auto">
        <div className="flex flex-col md:gap-8 gap-4  relative z-10">
          ...
          <div className="md:space-y-6 space-y-3">
            <h2 className="font-Gordita-Bold text-[18px] lg:text-[24px] leading-6 lg:leading-[32px] text-gray-900">
              We believe that a fresh coat of paint can transform any space.
            </h2>

            <div className="md:space-y-4 space-y-2">
              <p className="font-Gordita-Regular text-[15px] lg:text-[17px] leading-6 lg:leading-7 text-gray-600">
              ...
              <p className="font-Gordita-Regular text-[15px] lg:text-[17px] leading-6 lg:leading-7 text-gray-600 pt-4">
