...
export const GetInTouch = () => {
  ...
  return (
    <div className="md:py-16 py-10 px-6 md:px-10 bg-gradient-to-b from-[#77AEFFF7] to-[#BFD8FF]">
      <h2 className="font-Gordita-Medium text-center px-5 text-[20px] leading-[28.5px] mb-10 md:mb-16">
      ...
      <Button className="w-fit block mx-auto mt-16 font-Gordita-Medium text-white bg-[#3586FF] py-4 px-10 rounded-lg text-lg">
        Submit Requirement
      </Button>
    </div>
  );
