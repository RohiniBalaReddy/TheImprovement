    ...
    <div>
      ...
      <div className="w-full z-10">
        {packageData[active].data.map((item, index) => (
          <div className="relative flex flex-col w-full border-b-[1px] py-[10px] px-[10px] border-b-[#E6E6E6]" key={index}>
            <div className="flex flex-row justify-between items-center w-full py-1">
              <p className="font-Gordita-Medium md:text-[16px] text-[14px]">
                {item.title}
              </p>
              <div
