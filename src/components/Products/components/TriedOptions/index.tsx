  ...
  return (
    <div className="flex flex-col justify-center items-center mb-5">
      <div className="flex flex-col md:gap-5 gap-3 justify-center items-center mb-10">
        <p className="font-Gordita-Bold md:text-[24px] text-[20px] leading-7 text-center">
          Tired of multiple options available in the market?
        </p>
        <p className="max-w-[400px] font-Gordita-Regular md:text-[16px] text-[12px] text-[#7B7C83] text-center">
          No more worries! Here at TheImprovement, we provide all-round services in
          every price range!
        </p>
      </div>
        ...
        {data.map((item) => (
          ...
          >
            ...
            <div className="flex flex-col gap-2 py-4 px-3">
              <p className="md:text-[18px] text-[14px] font-Gordita-Bold">
                {item.title}
              </p>
