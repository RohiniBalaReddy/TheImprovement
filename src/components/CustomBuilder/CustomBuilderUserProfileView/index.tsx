    ...
    <>
      <div className="w-full p-[29px] space-y-6">
        ...
        <div className="flex flex-row items-center gap-2 cursor-pointer" onClick={() => router.back()} >
          <MdArrowBack />
          <p className="md:text-[16px] text-[14px] font-Gordita-Medium">
            Back
          </p>
        </div>
        <section className=" bg-white rounded-[8px] md:p-[24px] p-3">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <div>
              <p className=" text-[#6A6767] md:text-[14px] text-[12px] font-Gordita-Regular mb-[8px]">
                First name
              </p>
              <p className=" text-black md:text-[14px] text-[12px] font-Gordita-Medium">
                {user?.firstName}
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className=" text-black md:text-[14px] text-wrap  text-[12px] font-Gordita-Medium">
        ...
        <section className="bg-white rounded-[8px] md:p-[24px] p-3">
          ...
          <div className="grid  grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <div>
              <p className="text-[#6A6767] md:text-[14px] text-[12px] font-Gordita-Regular ">
                Country
              </p>
              <p className="text-black md:text-[14px] text-[12px] font-Gordita-Medium">
          ...
          {isSaving ? (
            ...
            <div className="flex flex-col gap-10">
              <div className=" rounded-md px-3 py-5">
                <div className="font-Gordita-Bold text-[18px] flex items-center gap-2 mb-4">
                  <CautionIcon />
                  <p>Contact details</p>
                </div>
                <div className="w-full flex flex-col gap-3 px-3 py-3">
                  <div className="flex md:flex-row flex-col gap-3">
                    <CustomInput
                      label="Mobile Number"
                      labelCls="text-[#636B70] text-[14px] font-Gordita-Medium"
                      name="phone"
