...
export default function ProjectOverviewAdminStyle() {
    ...
    const fetchLogs = async () => {
      ...
      try {
        const res = await apiClient.get(
          `${apiClient.URLS.customBuilder}/${custom_builder_id}/logs?page=${page}&limit=${limit}`
        );
  ...
  console.log(customBuilder?.phases);
  console.log(logs);
  ...
  const CustomYAxisTick = ({ x, y, payload }: any) => (
    <text
      ...
      dy={4}
      textAnchor="end"
      className="fill-yellow-500 md:text-[12px] text-[10px] font-Gordita-Medium"
    >
      {payload.value}%
    </text>
  );
            ...
            <div className="w-full md:max-w-[1200px] max-w-[360px]  mt-3 md:px-4 px-2">
              ...
              <div className="bg-white md:rounded-[10px] rounded-[4px] shadow-custom border border-gray-100 md:p-4 p-2">
                <Card className="shadow-custom border-none">
                  <CardContent className="flex flex-wrap items-center justify-between gap-3 md:gap-4 p-2">
                    <div className="flex md:flex-wrap flex-nowrap items-center gap-2">
                      ...
                      >
                        <SelectTrigger className="md:w-[200px] w-[120px] border-gray-200 h-[34px] text-[12px] md:text-[14px] font-Gordita-Medium md:rounded-[10px] rounded-[4px]">
                          <SelectValue placeholder="Select Month" />
                        </SelectTrigger>
                        <SelectContent
                          align="start"
                          className="bg-white border border-gray-100 py-1 font-Gordita-Medium md:text-[12px] text-[10px] rounded-md shadow-md"
                        >
                      ...
                      >
                        <SelectTrigger className="w-[120px] md:w-[140px] border-gray-200 h-[34px] text-[12px] md:text-[14px] font-Gordita-Medium md:rounded-[10px] rounded-[4px]">
                          <SelectValue placeholder="Select Week" />
                        </SelectTrigger>
                        <SelectContent
                          align="start"
                          className="bg-white border border-gray-100 font-Gordita-Medium md:text-[12px] text-[10px] rounded-md shadow-md"
                        >
                    ...
                    <div className="flex flex-wrap  items-center gap-2">
                      ...
                      >
                        ...
                        <SelectContent
                          align="start"
                          className="bg-white border border-gray-200 font-Gordita-Medium md:text-[12px] text-[10px] rounded-md shadow-md"
                        >
                          {[
                            "all",
                            "completed",
                ...
                <div className="flex flex-wrap justify-between items-center mt-3 mb-4 gap-3">
                  <div className="flex md:flex-wrap flex-nowrap items-center md:gap-2 gap-1 font-Gordita-Medium">
                    {(
                      [
                        "completed",
                        "in progress",
                ...
                <div className="overflow-x-auto rounded-md shadow-custom mt-4">
                  <table className="w-full text-[12px] border border-collapse border-gray-300 rounded-[4px] md:rounded-[10px] bg-white">
                    <thead>
                      <tr className="bg-gray-200 text-black text-left text-nowrap font-Gordita-Bold">
                    ...
                    <tbody>
                      {filteredRows?.length > 0 ? (
                        filteredRows?.map((log: any, index: number) => (
                          <tr
                            key={log.id}
                            className="hover:bg-gray-100 transition-colors  text-gray-800 font-Gordita-Medium"
                          >
                            ...
                            {selectedPhaseId === null && (
                              <td className="md:py-2 py-2 md:px-2 px-2 text-center font-Gordita-Medium border border-gray-300">
                  ...
                  {filteredRows?.length > limit && (
                    <div className="mt-4 flex gap-2 items-center flex-wrap">
                      ...
                      <select
                        ...
                        className="md:w-[55px] w-[45px] p-1 border border-gray-300 rounded font-Gordita-Medium text-[10px] md:text-[12px]"
                      >
                        {[5, 10, 15, 20].map((size) => (
...
const Legend: React.FC<LegendProps> = ({ data }) => {
  return (
    <div className="flex items-center md:gap-3 gap-1 md:text-[12px] text-[10px] font-Gordita-Medium">
