      ...
      <div className="flex md:gap-3 gap-2 px-1 py-2 md:py-1 w-full md:max-w-full max-w-[290px] overflow-x-auto">
        {tabValues.map((tab) => (
          <Button
            key={tab}
            className={twMerge(
              "md:px-4 md:py-2 px-2 py-1 min-w-max md:rounded-md rounded-[6px] text-[10px] text-nowrap md:text-[14px] font-Gordita-Medium",
              activeTab === tab
            ...
            {currentDocuments?.map((doc: any, index: number) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-2 md:p-1 p-1 text-[10px] md:text-[12px] font-Gordita-Medium text-gray-600">
                    <p>
                      <span className="font-Gordita-Bold text-black">
                        Title:
                      </span>{" "}
                      {doc?.title || "N/A"}
                    </p>
                    ...
                    {doc?.meta && (
                      <div className="mt-1 text-[10px] md:text-[12px] font-Gordita-Medium">
                        <p>
                          <span className="font-Gordita-Bold text-black">
                            Category:
                          </span>{" "}
      ...
      {previewUrl && (
        ...
        >
          <div className="flex items-center justify-between md:px-6 px-3 md:py-4 py-2 border-b border-gray-200 bg-gray-50 w-full">
            <h2 className="md:text-[14px] text-[12px] font-Gordita-Medium text-gray-800">
              View Document
            </h2>
          </div>
