  ...
  return (
    <div className="p-4 w-full flex flex-col gap-2">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          className="bg-[#3B82F6] text-white font-Gordita-Medium text-[12px] rounded-[6px] md:px-[14px] px-[10px] md:py-[6px] py-[4px]  md:text-[14px]"
        ...
        <div className="flex items-start justify-between md:px-6 px-3 md:py-6 py-4">
          ...
          <div className="relative">
            <Button
              ...
              className="flex items-center gap-2 bg-white border font-Gordita-Medium border-gray-300 btn-text text-nowrap md:py-[8px] py-[4px] md:px-4 px-2 rounded-lg"
            >
          ...
          {SelectedQuery?.adminReply ? (
            <div className="p-4 md:p-6">
              ...
              <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                <p className="text-[14px] md:text-[16px] font-Gordita-Medium text-gray-800">
                  {SelectedQuery.adminReply}
                </p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2 col-span-1">
                  ...
                  <CustomInput
                    ...
                    className="md:text-[14px] text-[12px] font-Gordita-Regular min-h-[100px] md:min-h-[140px] border border-[#CFCFCF] rounded-[8px] text-black px-3 "
                    rootCls="px-1"
