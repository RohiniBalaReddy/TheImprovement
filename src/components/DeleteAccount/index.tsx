...
const DeleteAccount = () => {
    ...
    console.log("user", user, userId, isAuthenticated);
                ...
                <div className='relative h-full w-full'>
                    {step === 1 && (
                        <div className="p-6 flex flex-col items-center md:gap-20  text-center ">
                            ...
                            <div className="flex gap-4 md:mt-10 mt-5 flex-row justify-between  w-full md:px-4">
                                <Button
                                    onClick={closeModal}
                                    className="px-5 py-2 border-2 font-Gordita-Medium border-[#002A32] hover:bg-gray-400 text-[#002A32] rounded-lg font-medium transition"
                                >
                                    Cancel
                                </Button>
                                <Button
                                    onClick={handleNext}
                                    className="px-5 py-2 bg-[#3B82F6] font-Gordita-Medium text-white rounded-lg font-medium hover:opacity-90 transition"
                                >
                                    Yes, deactivate
                                </Button>
                            </div>
                    ...
                    {step === 2 && (
                        <div className="p-6 flex flex-col items-center text-center space-y-5">
                            ...
                            <div className="flex gap-4 md:mt-10 mt-5 justify-between w-full px-4">
                                <Button onClick={() => setStep(1)} className="px-5 py-2 border-2 border-[#002A32] font-Gordita-Medium md:text-[16px] text-[14px] text-[#002A32] rounded-lg hover:bg-gray-100 transition">
                                    Back
                                </Button>
                                <Button onClick={handleNext} className="px-5 py-2 bg-[#3B82F6] text-white font-Gordita-Medium md:text-[16px] text-[14px] rounded-lg hover:opacity-90 transition">
                                    Continue
                                </Button>
                            </div>
                        </div>
                    ...
                    {step === 3 && (
                        <div className="p-6 flex flex-col items-center justify-between md:gap-10  text-center space-y-5">
                            ...
                            <div className="space-y-4 w-full font-Gordita-Medium text-[12px]">
                            ...
                            <div className="flex gap-4 md:mt-10 mt-5 justify-between w-full px-4">
                                <Button onClick={handleBack} className="px-5 py-2 border-2 border-gray-300 font-Gordita-Medium text-[#002A32] rounded-lg hover:bg-gray-100 transition">
                                    Back
                                </Button>
                                <Button
                                    onClick={handleDeactivate}
                                    className={`px-5 py-2 bg-[#3B82F6] font-Gordita-Medium text-[14px] text-white rounded-[6px] hover:opacity-90 transition`}
                                >
                                    Continue
                                </Button>
                            </div>
        ...
        <>
            <div className="flex flex-col items-center justify-between bg-white h-full gap-6 p-6 max-w-[860px] rounded-md md:mt-10 shadow-custom">
                <div className="flex flex-col items-center gap-2">
                    ...
                    <h2 className="md:text-[24px] text-[18px] font-Gordita-Medium">Account settings</h2>
            ...
            <div className="grid gap-2 mb-3">
                {data && Object.entries(data).map(([key, value]: any) =>
                    (typeof value === 'boolean' ? value : value > 0) ? (
                        <div key={key} className="flex items-center justify-center font-Gordita-Medium gap-2 text-sm text-gray-700">
                            {iconMap[key]}
                            <span>
                                {labelMap[key]}
