        ...
        <div className="w-full min-h-[inherit] h-full flex md:flex-row flex-col">
          <div className="relative md:w-[45%] min-h-full  flex justify-center">
            ...
            <div className="flex flex-col justify-center items-center py-[80px]">
              ...
              <p className="relative text-[32px] leading-[42px] text-center text-white font-Gordita-Bold">
          ...
          <div className="relative md:w-[55%] flex flex-col items-center justify-center bg-white p-10">
            <div className="max-w-[350px] w-full">
              ...
              <CustomInput
                ...
                labelCls="font-Gordita-Medium md:text-[16px] text-[14px]"
                rootCls="mb-6"
                type={"text"} />
              ...
              <div className="mb-6">
                <p className="text-[14px] mb-2 font-Gordita-Medium">Are you a Real Estate Agent?</p>
              ...
              <div className="mt-4 font-Gordita-Medium">
                <p>
